...
# Footer
st.markdown("---")
st.caption("Audiomack ArtistRank Dashboard | Data period: April 7-13, 2025 | Last updated: April 14, 2025")
st.caption("Created by LinLin for Audiomack Internship Program Week
